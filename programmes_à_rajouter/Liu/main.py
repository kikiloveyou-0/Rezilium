...
class Game:
    ...
    def respawnnew(self):
        ...
        self.msg_tnr = MessageTNR(self, 52, 23)
    ...
    def run(self):
        ...
        while self.playing:
            ...
            if self.gamestart == True:
                ...
                if start_time + 3000 < pygame.time.get_ticks():
                    self.msg_tnr.x = 52
    ...
    def mouvement(self):
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if (event.key != pygame.K_RIGHT) and (event.key != pygame.K_LEFT) and (event.key != pygame.K_UP) and (event.key != pygame.K_DOWN) and (event.key != pygame.K_ESCAPE) and (event.key != pygame.K_e):
                    self.msg_tnr.x = 12
